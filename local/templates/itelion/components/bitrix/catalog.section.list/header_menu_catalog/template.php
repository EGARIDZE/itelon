...
<div class="desktop-menu__item">
	<div class="desktop-menu-nav">
		<ul class="desktop-menu-nav__links">
			<?foreach ($arResult['SECTIONS'] as $key => $arSection) {
                ...
                <? if(empty($arSection['CODE'])):?>
                    <li class="desktop-menu-nav__link<?= $key == 0 ? ' _visible' : ''; ?>" data-link="catalog<?= $key; ?>" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
                        <h3>
                            <?
                ...
                <? else:?>
                    <li>
                        <span class="btn btn_medium btn_menu btn-icon btn-icon_reverse btn-icon_hover">
                            <span class="children"><?= $arSection['NAME']; ?></span>
                            <a href="<?= $arSection['CODE']?>" class="cover "></a>
                        </span>
                    </li>
                <? endif;?>
			<? } ?>
		...
		<div class="desktop-menu-nav__items">
			<?foreach ($arResult['SECTIONS'] as $key => $arSection) { ?>
				<div class="desktop-menu-nav__body<?= $key == 0 ? ' _visible' : ''; ?>" data-menu="catalog<?= $key; ?>">

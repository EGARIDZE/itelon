		...
		<div class="filter__wrapper">
			...
			<div class="filter__main">
				...
				<div class="filter__list">
					...
					*/?>
					...
					foreach($arResult["ITEMS"] as $key=>$arItem)
					{
						...
						$open = $arItem['DISPLAY_EXPANDED'] == 'Y' ? ' _open' : '';
                        ?>
						...
						<div class="filter__item">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
												...
												<ul>
													...
													<?foreach ($arItem["VALUES"] as $val => $ar):
														...
														if ($ar["DISABLED"])
															$class.= " disabled";
													?>
														<li class="<?=$ar['DISABLED']?'invisible':'';?>">
															<label for="<?=$ar["CONTROL_ID"]?>"
								...
								default:
									?>
								<div class="filter__body<?=$open;?>">
									<div class="filter__inputs">
										<?foreach($arItem["VALUES"] as $val => $ar):?>
											<div class="filter-checkbox<?=$ar['DISABLED']?' invisible':'';?>">
												<input value="<? echo $ar["HTML_VALUE"] ?>" name="<? echo $ar["CONTROL_NAME"] ?>" id="<? echo $ar["CONTROL_ID"] ?>" data-type="checkbox" <? echo $ar["CHECKED"]? 'checked="checked"': '' ?> <? echo $ar["DISABLED"] ? 'disabled': '' ?> type="checkbox" onclick="smartFilter.click(this)">
												<span><?=$ar["VALUE"];?></span>
											</div>
										<?endforeach;?>
									</div>
				...
				<div class="filter__btns">
					...
					<button class="btn btn_large btn_secondary" onclick="smartFilter.click(this)">
						<span class="children"><?=GetMessage("CT_BCSF_SET_FILTER")?></span>
					</button>
                    <input type="hidden" id="set_filter" name="set_filter" type="submit" value="<?=GetMessage("CT_BCSF_SET_FILTER")?>">
					<!--Для блокировки добавить класс _disabled-->
					<button class="btn btn_large btn_outlined" id="del_filter" name="del_filter" type="submit" value="<?=GetMessage("CT_BCSF_DEL_FILTER")?>">
						<span class="children"><?=GetMessage("CT_BCSF_DEL_FILTER")?></span>
					</button>

...
<? endif ?>
<div class="lock-padding popup popup-form<?=$strFormClass;?>" id="consultation" data-form-info>
    <div class="popup__body">
        <div class="popup__content">
            <div class="popup__wrapper"
                 style="background-image: url('<?= SITE_TEMPLATE_PATH ?>/files/images/consultation.png');">
				<?= $arResult["FORM_HEADER"] ?>
                <div class="popup-form__wrapper">
                    <div class="popup-form__preview">
                        <h2><?= $arResult['FORM_TITLE'] ?></h2>
                        <p>Заполните небольшую форму и получите <br>профессиональную консультацию ИТ-эксперта в
                            кратчайший срок!
                        </p>
                    </div>
                    <div class="popup-form__form">
                        <div class="form-group textarea__container">
							<?= $arResult['QUESTIONS']['SIMPLE_QUESTION_779']['HTML_CODE'] ?>
                            <span class="textarea__label"><?= $arResult['QUESTIONS']['SIMPLE_QUESTION_779']['CAPTION'] ?></span>
                        </div>
                        <div class="form-group input__container input__container_text">
							<?= $arResult['QUESTIONS']['SIMPLE_QUESTION_480']['HTML_CODE'] ?>
                            <span class="input__label"><?= $arResult['QUESTIONS']['SIMPLE_QUESTION_480']['CAPTION'] ?></span>
                        </div>
                        <div class="form-group input__container input__container_phone">
							<?= $arResult['QUESTIONS']['SIMPLE_QUESTION_272']['HTML_CODE'] ?>
                            <span class="input__label"><?= $arResult['QUESTIONS']['SIMPLE_QUESTION_272']['CAPTION'] ?></span>
                        </div>
                    ...
                    <div class="popup-form__info">
                        <div class="popup-form__info--content">
                            <div class="popup-form__info--text">
                                <p><span data-form-output="name"></span><?=$arValues['form_text_24'];?>, спасибо за ваш запрос!</p>
                                <p>Ваш телефон: <span data-form-output="phone"><?=$arValues['form_text_25'];?></span></p>
                                <p>Ваша почта: <span data-form-output="email"><?=$arValues['form_email_157'];?></span></p>
                                <p class="popup-form__info--comment">Задача: <span data-form-output="task"><?=$arValues['form_textarea_28'];?></span></p>
                            </div>
                            <div class="popup-form__info--text">
                                <p>

...
<? endif ?>
<div class="lock-padding popup popup-form<?=$strFormClass;?>" id="get_analog_form" data-form-info>
                ...
                <div class="popup-form__wrapper">
                    ...
                    <div class="popup-form__form">
                        ...
                        <div class="form-group textarea__container">
		                    <?= $arResult['QUESTIONS']['SIMPLE_QUESTION_260']['HTML_CODE'] ?>
                            <span class="textarea__label"><?= $arResult['QUESTIONS']['SIMPLE_QUESTION_260']['CAPTION'] ?></span>
                        </div>
                    ...
                    <div class="popup-form__info">
                        <div class="popup-form__info--content">
                            <div class="popup-form__info--text">
                                <p><span data-form-output="name"></span><?=$arValues['form_text_178'];?>, спасибо за ваш запрос!</p>
                                <p>Ваш телефон: <span data-form-output="phone"><?=$arValues['form_text_179'];?></span></p>
                                <p>Ваша почта: <span data-form-output="email"><?=$arValues['form_email_180'];?></span></p>
                                <p class="popup-form__info--comment">Комментарий: <span data-form-output="task"><?=$arValues['form_textarea_181'];?></span></p>
                            </div>
                            <div class="popup-form__info--text">
                                <p>

...
if ($arResult["isFormNote"] == "Y"):
    ...
    ?>
    <script>
        $.getScript('/local/lib/js/common.js', function () {
            let btnIndex = +localStorage.getItem('btn_index');
            let $btn = $('.basket-call').eq(btnIndex);
            copyHtmlDataToForm($btn);
        });
        ym(13396396,'reachGoal','form.send');
    </script>
<? endif; ?>

<div class="lock-padding popup popup-form<?=$strFormClass;?>" id="basket" style="padding-right: 8px;" data-form-info>
    <div class="popup__body">
        <div class="popup__content">
            <div class="popup__wrapper" style="background-image: url('<?= SITE_TEMPLATE_PATH ?>/files/images/choose_desktop2025.webp');">
                    ...
                    <div class="popup-form__container">
                        ...
                        <div class="popup-form__block">
                            ...
                            <div class="popup-form__results">
                                <div class="popup-form__result description">
                                </div>

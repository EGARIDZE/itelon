<?// подпишитесь на новости в деталке новостей/блога
...
<section class="section">
    <div class="container">
        <div class="billboard"
             style="background-image: url('<?= SITE_TEMPLATE_PATH ?>/files/images/billboard_subscribe.webp')">
            ...
            <div class="billboard__callback">
                ...
                <div class="billboard__form">
                    ...
                    <div class="billboard__inputs billboard__inputs_subscribe">

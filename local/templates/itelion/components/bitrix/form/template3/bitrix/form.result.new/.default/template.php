<?//Обсудить проект с системным архитектором - деталка кейса/решения
...
<section class="section">
    <div class="container">
        <div class="billboard" style="background-image: url('<?= SITE_TEMPLATE_PATH ?>/files/images/billboard_architect.webp')">
                ...
                <div class="billboard__form">
                    ...
                    <div class="billboard__inputs">
                        <div class="form-group input__container input__container_text ">
							<?= $arResult['QUESTIONS']['SIMPLE_QUESTION_514']['HTML_CODE'] ?>
                            <span class="input__label"><?= $arResult['QUESTIONS']['SIMPLE_QUESTION_514']['CAPTION'] ?></span>
                        </div>


                        <div class="form-group input__container input__container_phone">
							<?= $arResult['QUESTIONS']['SIMPLE_QUESTION_261']['HTML_CODE'] ?>
                            <span class="input__label"><?= $arResult['QUESTIONS']['SIMPLE_QUESTION_261']['CAPTION'] ?></span>
                        </div>

...
$containerName = 'sim_container-'.$navParams['NavNum'];

?>
<div class="section__wrapper">
    <div class="similar__list" data-entity="<?=$containerName?>">
    ...
    {
        ?>
        <span class="btn btn_medium btn_outlined" data-entity="lazy-<?=$containerName?>" id="load-more-<?=$containerName?>" data-use="show-more-<?=$navParams['NavNum']?>">

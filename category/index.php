...
$APPLICATION->SetPageProperty("title", "ITELION");
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"USE_STORE" => "N",
		"COMPONENT_TEMPLATE" => "catalog_last",
		...
		"SEF_URL_TEMPLATES" => array(
			...
			"smart_filter" => $arr[1]."/".$arr[2]."/filter/#SMART_FILTER_PATH#/apply/",
		),
